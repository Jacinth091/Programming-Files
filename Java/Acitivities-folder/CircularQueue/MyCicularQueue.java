...
public class MyCicularQueue
{
   public static void main(String[] args){
               ...
               if(input == null){
                   ...
                   switch(choice){
                       case 1:
                           ...
                           circularQueue = new CicularQueue();
                           StringBuilder subMenuStr = getStr(subMenu, "Queue Node Menu");
                           HandleQueueNodeOperations(circularQueue,subMenu, subMenuStr.toString());
    ...
    public static boolean HandleOperationRedirection(CicularQueue circularQueue, int choice) throws Exception
    {
       switch(choice){
           case 1:
                ...
                if(input == null){
                    ...
                    boolean enqueue = circularQueue.enqueue(input);
                    if(enqueue){
...
//                        queueNode.enqueue(input);
                        JOptionPane.showMessageDialog(null, circularQueue.toString(), "Current Items Queued", JOptionPane.PLAIN_MESSAGE);
...
//           break;
   ...
   public static void HandleQueueNodeOperations(CicularQueue circularQueue, String[] subMenu, String subMenuStr){
       boolean exitFlag = false;
       int choice = 0 ;
        while(!exitFlag)
        {
            try{
                ...
                if(input == null){
                    ...
                    exitFlag = HandleOperationRedirection(circularQueue, choice);
                }
            }catch(Exception ex){
                JOptionPane.showMessageDialog(null, ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
            }
